...
Además, el sistema incluye un **algoritmo de promociones aleatorias** que aplica descuentos o aumentos sobre el total de compra, brindando una experiencia dinámica al cliente.
...
- **Interfaz:** Java Swing y componentes visuales personalizados
...
- Cálculo de impuestos (IVA, ICA, Retefuente).  
- Módulo de promociones dinámicas (descuentos y aumentos).  
- Exportación de datos y visualización de reportes.  
- Interfaz gráfica intuitiva para todos los perfiles.
...
- Sistema de cálculo tributario automatizado.  
- Interfaz amigable y adaptable a distintos dispositivos.  
- Flujo de compra completo: autenticación → selección → factura.
